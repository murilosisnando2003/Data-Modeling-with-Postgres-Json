...
songplay_table_create = (""" CREATE TABLE IF NOT EXISTS SONGPLAYS(songplay_id int  NOT NULL PRIMARY KEY, start_time bigint  , user_id int, level varchar, song_id varchar, artist_id varchar, session_id int , location varchar, user_agent varchar);
""")
...
song_table_create = ("""CREATE TABLE IF NOT EXISTS SONGS  (song_id varchar  NOT NULL PRIMARY KEY, title varchar, artist_id varchar, year int, duration decimal);
""")
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS TIME  (start_time time NOT NULL , hour varchar, day varchar, week varchar, month varchar, year varchar, weekday varchar);
""")
